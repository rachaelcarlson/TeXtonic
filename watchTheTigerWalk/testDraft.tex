...
A sign of a healthy musician appears to be her internet presence, calculated by YouTube \emph{views} and Facebook \emph{likes}.
...
\subsection{The Data}
\label{sec:data}
42 artist websites were analyzed. 21 artists could be considered up-and-coming and 21 could be
...
future to take a more thorough look at the wider world of non-popular
musicians's internet presence in order to inform the twenty-first century
finger-style guitarist. A concerted effort was
made to include musicians outside of the United States. Only the artists who
had websites were analyzed. A small number of up-and-coming artists of
reputation do not appear to have websites. These individuals appear to utilize
FaceBook as their primary means of establishing their craft on the internet.

26 items were coded into the data set. These codes
range from the manner in which the artist attested to his or her legitimacy to
the type of Content Management System (\textsc{cms}) that the artist
uses. These were carefully selected to demonstrate important elements of an
artist's website. 
