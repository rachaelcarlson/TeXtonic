...
Several questions, ranging from visual to technical were asked of each web site. These are shown in Table 2.
...
\end{margintable}
While it may have seemed arbitrary at first to ask some of these questions,
the responses to some are quite surprising. 
